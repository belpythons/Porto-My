...
Ini adalah portofolio pribadi saya yang dibangun menggunakan Next.js 13 dengan App Router dan TypeScript. Portofolio ini menampilkan proyek, pengalaman, dan keahlian saya.
...
Porto-My/
├── app/
│   ├── (root)/              # Grup rute untuk halaman utama
│   │   ├── projects/        # Halaman daftar & detail proyek
│   │   ├── experience/      # Halaman pengalaman (timeline)
│   │   ├── skills/          # Halaman keahlian
│   │   ├── resume/          # Halaman resume
│   │   ├── contact/         # Halaman formulir kontak
│   │   └── page.tsx         # Halaman beranda
│   ├── api/                 # Rute API (misal: /api/contact)
...
│   └── ...                  # Komponen spesifik halaman lainnya
├── config/                  # File konfigurasi (data proyek, navigasi, dll.)
├── hooks/                   # Kustom React Hooks
├── lib/                     # Fungsi utilitas (misal: cn dari clsx)
├── providers/               # Penyedia konteks (Tema, Animasi)
